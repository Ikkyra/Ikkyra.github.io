...
<body class="darkmode">
    ...
    <main>
        <!-- Hero Section -->
        <section class="hero">
            <h1>DELICIOUS RECIPES, <br> minimal effort.</h1>
            <p>Savor the taste of home-cooked meals with recipes designed to save you time and energy, while still delivering maximum flavor.</p>
        ...
        <section class="search">
            <form action="" method="GET">
                <input type="text" name="search" placeholder="Search recipes..." value="<?php echo isset($search) ? ($search) : ''; ?>">
    ...
    <script type="text/javascript" src="Assets/javascript/start.js" defer></script>
</body>
</html>
